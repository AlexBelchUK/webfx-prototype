...
public class A1Generic<T> {
	...
	private dev.webfx.prototype.test.c.C6BasicClass c6Field;
	...
	public static dev.webfx.prototype.test.c.C6BasicClass staticMethod(A1Generic a1Arg, B1 b1Arg) {
		return new dev.webfx.prototype.test.c.C6BasicClass();
	}
}
